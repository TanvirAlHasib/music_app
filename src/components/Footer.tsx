...
function Footer() {
  return (
    ...
    <footer className="bg-gray-950 lg:grid lg:grid-cols-5 w-full">
        ...
        <div className="px-4 py-16 sm:px-6 lg:col-span-3 lg:px-8">
            ...
            <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
                ...
                <ul className="mt-6 space-y-4 text-sm">
                    ...
                    <li>
                    <a href="#" className="text-white transition hover:opacity-75"> Piano for Beginners </a>
                    </li>

                    <li>
                    <a href="#" className="text-white transition hover:opacity-75"> Guitar Fundamentals </a>
                    </li>
                </ul>
                </div>
            ...
            <div className="sm:flex sm:items-center sm:justify-between">
                ...
                <p className="mt-8 text-xs text-white sm:mt-0">
                👩‍💻 Developed by <Link href={"www.linkedin.com/in/tanvir-al-hasib"} className='underline'>Tanvir Al Hasib</Link>
                </p>
